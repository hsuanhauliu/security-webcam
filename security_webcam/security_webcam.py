...
def main():
    """ Main function """
    verbose, output_path, top_fps, buffer_length = parse_inputs()
    ...
    while True:
        clip = start_recording(cap, fps=top_fps, buffer_length=buffer_length, show_cam=False, verbose=verbose)
...
def parse_inputs():
    ...
    return args.verbose, args.output, args.fps, args.buffer_length
